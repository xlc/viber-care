...
import { buildLearningSequence } from "../../src/learning/engine";
import { DEFAULT_SETTINGS, type WordGardenSettings } from "../../src/state/settings";
...
describe("learning engine", () => {
  it("uses the configured language order", () => {
    ...
    expect(sequence.map((item) => item.resolvedLanguage)).toEqual(["zh-Hans", "en"]);
