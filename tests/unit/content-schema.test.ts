...
import { ContentValidationError, validateContentPacks } from "../../src/content/build-catalog";
...
describe("content schema validation", () => {
  ...
  it("reports missing MVP language content", () => {
    ...
    expect(() => validateContentPacks([brokenPack])).toThrow(ContentValidationError);
    expect(() => validateContentPacks([brokenPack])).toThrow(/missing zh-Hans content/);
  });
});
