...
export function speakSequence(sequence: LearningPresentation[], muted: boolean): void {
  ...
  for (const item of sequence) {
    ...
    utterance.lang = speechLanguageMap[item.resolvedLanguage] ?? item.resolvedLanguage;
    utterance.rate = 0.82;
